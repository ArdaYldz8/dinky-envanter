-- DINKY DEPO - Gerçek Stok Verileri Import (Fixed Version)
...
('MAKİDA MATKAP VİDALAMA BİR', 'DİNKY-016', 'Adet', 1, 1),
...
('MAKİDA MATKAP VİDALAMA İKİ', 'DİNKY-021', 'Adet', 1, 1),
...
-- Başarı mesajı
SELECT 'DINKY Gerçek Stok Verileri Başarıyla Yüklendi! 84 Ürün Eklendi.' as result;
